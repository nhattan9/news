...
<head>
    ...
    <link rel="stylesheet" href="{{asset('adminTemplate/demo/assets/css/pages/error.css')}}">
</head>
    ...
    <div id="error">
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <img class="img-error" src="{{asset('adminTemplate/demo/assets/images/samples/error-403.png')}}" alt="Not Found">
                <div class="text-center">
                    <h1 class="error-title">Forbidden</h1>
                    <p class="fs-5 text-gray-600">Bạn không được phép vào trang này .</p>
