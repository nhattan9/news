...
@section('title')
 <title>Sửa Roles </title>
@endsection

@section('content')
@include('admin.partials.breadcum',['name' => 'Roles', 'key' => 'Edit'])
<br>
            ...
            <div class="card bg-primary ">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="form" action=" {{ route('admin.roles.update',['id' => $role->id]) }} " method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-2">
                                        ...
                                        <div class="form-check">
                                            <div class="checkbox">
                                                <input type="checkbox" 
                                                       ...
                                                       {{ $permissionChecked->contains('id',$permissionChildsItem->id) ? 'checked="checked"' : ''}}
                                                       >
                            ...
                            <div class="col-12 d-flex justify-content-end">
                                <button type="submit" class="btn btn-light-primary me-1 mb-1">Update</button>
