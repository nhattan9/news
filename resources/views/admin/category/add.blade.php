...
@section('content')
@include('admin.partials.breadcum',['name' => 'Category', 'key' => 'Add'])
        ...
        <div class="col-md-7 col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form  action="{{ route('admin.categories.store') }}"  class="form form-vertical" method="post">
                            @csrf
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-6">
                                        <div class="form-check">
                                            <div class="checkbox">
                                                ...
                                                <input type="checkbox" id="checkbox3" class="form-check-input" checked="" name="show_on_menu">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6 mb-2">
                                        <div class="form-check">
                                            <div class="checkbox">
                                                ...
                                                <input type="checkbox" id="checkbox4" class="form-check-input" checked="" name="show_on_homepage">
                                            </div>
                                        </div>
                                    </div>
